...
![banner](https://pbs.twimg.com/profile_banners/1867451627822616576/1734078814/1500x500)
...
Follow our AI agent: [@Alya_RIG](https://x.com/Alya_RIG)

## Overview

Alya is a cutting-edge AI social media agent designed to autonomously engage with users, craft posts, and interact on platforms like X. Built in Rust for performance and reliability, Alya leverages the rig framework to provide AI-driven functionality, ensuring natural conversation flow and a consistent, dynamic personality.
